...
public class FristIntroActivity extends AppCompatActivity {

    private AppCompatImageView imNext, imSkip;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frist_intro_activity);
        ...
        imSkip = findViewById(R.id.imskip);
        ...
        imSkip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int current = getItem(+1);
                if (current < layouts.length) {
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(FristIntroActivity.this, MainActivity.class));
        finish();
    }
